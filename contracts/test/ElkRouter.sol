...
import '@elkdex/avax-exchange-contracts/contracts/elk-core/interfaces/IElkFactory.sol';
import '@elkdex/avax-exchange-contracts/contracts/elk-core/interfaces/IElkPair.sol';
import '@elkdex/avax-exchange-contracts/contracts/elk-lib/libraries/TransferHelper.sol';

import '@elkdex/avax-exchange-contracts/contracts/elk-periphery/interfaces/IElkRouter.sol';
import '@elkdex/avax-exchange-contracts/contracts/elk-periphery/libraries/ElkLibrary.sol';
import '@elkdex/avax-exchange-contracts/contracts/elk-periphery/libraries/SafeMath.sol';
import '@elkdex/avax-exchange-contracts/contracts/elk-periphery/interfaces/IERC20.sol';
import '@elkdex/avax-exchange-contracts/contracts/elk-periphery/interfaces/IWAVAX.sol';
...
contract ElkRouter is IElkRouter {
    ...
    function _addLiquidity(
        ...
        address pair = IElkFactory(factory).getPair(tokenA, tokenB);
        (uint reserve0, uint reserve1, ) = IElkPair(pair).getReserves();
