...
import "@elkdex/avax-exchange-contracts/contracts/elk-lib/libraries/FixedPoint.sol";
...
import "@elkdex/avax-exchange-contracts/contracts/elk-periphery/libraries/UniswapV2OracleLibrary.sol";
...
contract ElkDexOracle {
    ...
    function update(address _tokenA, address _tokenB) public {
        ...
        require(_tokenA != _tokenB, "SlidingWindowOracle: IDENTICAL_ADDRESSES");
