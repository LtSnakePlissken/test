...
import type {
  IElkRouter,
  IElkRouterInterface,
} from "../../../../../../@elkdex/avax-exchange-contracts/contracts/elk-periphery/interfaces/IElkRouter";
...
export class IElkRouter__factory {
  ...
  static createInterface(): IElkRouterInterface {
    return new Interface(_abi) as IElkRouterInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): IElkRouter {
    return new Contract(address, _abi, runner) as unknown as IElkRouter;
  }
}
