...
export interface StakingFeeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "balances"
      | "collectedFees"
...
export interface StakingFee extends BaseContract {
  connect(runner?: ContractRunner | null): StakingFee;
  waitForDeployment(): Promise<this>;

  interface: StakingFeeInterface;
