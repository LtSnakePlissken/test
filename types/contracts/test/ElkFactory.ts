...
export interface ElkFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allPairs"
      | "allPairsLength"
...
export interface ElkFactory extends BaseContract {
  connect(runner?: ContractRunner | null): ElkFactory;
  waitForDeployment(): Promise<this>;

  interface: ElkFactoryInterface;
