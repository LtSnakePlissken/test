...
export interface ElkRouterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "WAVAX"
      | "addLiquidity"
...
export interface ElkRouter extends BaseContract {
  connect(runner?: ContractRunner | null): ElkRouter;
  waitForDeployment(): Promise<this>;

  interface: ElkRouterInterface;
