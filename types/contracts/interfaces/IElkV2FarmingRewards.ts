...
export interface IElkV2FarmingRewardsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addRewardToken"
      | "balances"
...
export interface IElkV2FarmingRewards extends BaseContract {
  connect(runner?: ContractRunner | null): IElkV2FarmingRewards;
  waitForDeployment(): Promise<this>;

  interface: IElkV2FarmingRewardsInterface;
