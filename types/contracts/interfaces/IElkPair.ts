...
export interface IElkPairInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "MINIMUM_LIQUIDITY"
...
export interface IElkPair extends BaseContract {
  connect(runner?: ContractRunner | null): IElkPair;
  ...
  mint: TypedContractMethod<[_to: AddressLike], [bigint], "nonpayable">;
  ...
  skim: TypedContractMethod<[_to: AddressLike], [void], "nonpayable">;
