...
export interface IElkFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allPairs"
      | "allPairsLength"
...
export interface IElkFactory extends BaseContract {
  connect(runner?: ContractRunner | null): IElkFactory;
