...
export interface StakeFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allFarms"
      | "allFarmsLength"
...
export interface StakeFactory extends BaseContract {
  connect(runner?: ContractRunner | null): StakeFactory;
  ...
  getCreator: TypedContractMethod<[farmAddress: AddressLike], [string], "view">;

  getStake: TypedContractMethod<
    [creator: AddressLike, stakingTokenAddress: AddressLike],
    [string],
    "view"
  >;
  ...
  ): TypedContractMethod<[farmAddress: AddressLike], [string], "view">;
  getFunction(
