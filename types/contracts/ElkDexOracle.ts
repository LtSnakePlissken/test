...
export interface ElkDexOracleInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "consult"
      | "consultWeth"
...
export interface ElkDexOracle extends BaseContract {
  connect(runner?: ContractRunner | null): ElkDexOracle;
  waitForDeployment(): Promise<this>;

  interface: ElkDexOracleInterface;
