...
export interface ElkV2FarmingRewardsPermissionedInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addRewardToken"
      | "balances"
  ...
  encodeFunctionData(
    functionFragment: "permittedAddresses",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export interface ElkV2FarmingRewardsPermissioned extends BaseContract {
  connect(runner?: ContractRunner | null): ElkV2FarmingRewardsPermissioned;
  waitForDeployment(): Promise<this>;

  interface: ElkV2FarmingRewardsPermissionedInterface;
  ...
  permittedAddresses: TypedContractMethod<
    [arg0: AddressLike],
    [boolean],
    "view"
  >;
  ...
  getFunction(
    nameOrSignature: "permittedAddresses"
