...
export interface ElkPairInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "MINIMUM_LIQUIDITY"
...
export interface ElkPair extends BaseContract {
  connect(runner?: ContractRunner | null): ElkPair;
  waitForDeployment(): Promise<this>;

  interface: ElkPairInterface;
