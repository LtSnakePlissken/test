...
async function deployContractsDep() {
    ...
    const FarmingRewards = new ethers.Contract("0x0000000000000000000000000000000000000000", FarmingRewardsAbi.abi, ethers.provider)
    ...
    const FarmFactory = await (await ethers.getContractFactory("ElkFarmFactory", {libraries: {ElkFactoryHelper: FactoryHelper.address, ElkFactoryHelperPermissioned: FactoryHelperPermissioned.address}})).deploy(ElkDexOracle.address)
